                ...
                {!! Form::open(array('route' => 'email.store','method'=>'POST','class'=>'form mt-4 ml-3')) !!}
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12 col-xl-11 col-sm-12 save-btn">
                            <a href="{{ route('email.index') }}"><button  type="button" class="btn btn-outline-primary "><img class="back-btn" src="{{ asset('assets/images/icons/back.svg') }}" style="width: 14px;margin-right: 10px">Cancel</button></a>

                    ...
                    <div class="form mt-5">                        
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-md-12 col-xl-11 col-sm-12 save-btn">
                                <button type="button" class="btn btn-outline-primary change-password" data-url="{{ route('branchadmin-updatepassword') }}"><i
...
@endsection
@section('js-hooks')
<script src="{{ asset('assets/js/branchadmin/change_password.js') }}" defer></script>
@endsection
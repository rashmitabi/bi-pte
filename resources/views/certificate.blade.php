    ...
    <div id="details" class="clearfix">
      ...
      <div id="invoice" style="width: 30%;float: right;text-align: center;">
        <div style="display: block;width: 110px;margin: 0 auto;">
          ...
          <span style="display: block;background-color: #a0007e;color: #fff; padding: 0px 30px 20px 25px; font-size: 50px;border-bottom-right-radius: 60px; border-bottom-left-radius: 60px;">{{ $data['certificate']->score }}</span>
        </div>
      </div>
    </div>

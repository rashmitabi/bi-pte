<form class="form mt-4 ml-3" method="post" enctype="multipart/form-data" action="">
@csrf
...
<div class="form-group row">
    <div class="col-12 col-md-12 col-xl-11 col-sm-12 save-btn">
        <button type="button" class="btn btn-outline-primary file-update" data-id="{{ $prediction->id }}" data-url="{{ route('predictionfiles.update', $prediction->id) }}">

   ...
   <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
         <div class="right-navbar-wrap">
            ...
            <div class="profile-user-wrap">
            <a href="#" class="profile-name">{{ Auth::user()->first_name }} {{ Auth::user()->last_name }} <i class="fas fa-chevron-down"></i> <img src="{{ asset('assets/images/Userprofile.png') }}" class="">
               </a>
               ...
               <div class="logout-dropdown">
                   <div class="notifications-main-wrap">
                     <ul>
                        ...
                        <li> <a href="#"> <i class="fas fa-sign-out-alt"></i> Sign Out </a>
                        </li>
                     </ul>
                  </div>

...
<div>
  <nav id="sidebar">
      <ul class="list-unstyled components">
         ...
         <li>
            <a href="#Usersubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> <img src="{{ asset('assets/images/icons/dashboard.svg') }}" class=""> <span> Manage Users </span></a>

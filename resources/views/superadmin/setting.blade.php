            ...
            <div class="col-12 col-md-12 col-xl-8 col-sm-12 left">
                <form action="" name="settings" id="settings" enctype="multipart/form-data">
                    <div class="form">
                        ...
                        <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Admin Email Address</label>
                        <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Customer Email Address</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Company Name</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Company Mobile Number</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Company Address</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Company Invoice Address</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Company GST Number</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">HSN Code</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">STGST (in %age) </label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">CGST (in %age) </label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">IGST (in %age) </label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                        <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Digital Signature</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">                              
            ...
            <div class="col-12 col-md-12 col-xl-8 col-sm-12 left">
                <form id="readingQuestionInstuction" name="readingQuestionInstuction">
                    <div class="form">
                        ...
                        <div class="form-group row">
                        <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Reading and Writing:Fill in the blanks</label>
                        <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Multiple-choice,Choose multiple answers</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Re-order Paragraphs</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Reading:Fill in the blanks</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Multiple-choice,choose single answers</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
            ...
            <div class="col-12 col-md-12 col-xl-8 col-sm-12 left">
                <form id="listeningQuestionInstuction" name="listeningQuestionInstuction">
                    <div class="form">
                        ...
                        <div class="form-group row">
                        <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Summarize Spoken item</label>
                        <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Choose Multiple answers item</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Fill in the blanks</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Highlight correct summary item</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Multiple-choice,choose single answers item</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Select missing word item</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Highlight Incorrect Word</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Write Form Dictations</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
            ...
            <div class="col-12 col-md-12 col-xl-8 col-sm-12 left">
                <form id="listeningInstruction" name="listeningInstruction">
                    <div class="form">
                        ...
                        <div class="form-group row">
                        <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Summarize Written</label>
                        <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                        <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Essay Writing</label>
                        <div class="col-12 col-md-7 col-xl-7 col-sm-12">
            ...
            <div class="col-12 col-md-12 col-xl-8 col-sm-12 left">
                <form id="speakingInstruction" name="speakingInstruction">
                    <div class="form">
                        ...
                        <div class="form-group row">
                        <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Read Aloud</label>
                        <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Repeat Sentence</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Describe Image</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Re-tell lecture</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label  class="col-12 col-md-5 col-xl-5 col-sm-12 col-form-label required">Answer-short Question</label>
                            <div class="col-12 col-md-7 col-xl-7 col-sm-12">

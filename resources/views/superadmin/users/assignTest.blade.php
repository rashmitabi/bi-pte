                ...
                <div class="test-series">
                    ...
                    <div class="form-group row">
                        <div class="col-11 assign-btn">
                                <button type="button" class="btn btn-outline-primary store-assign-test" data-test-type="{{ $type }}" data-user-id="{{ $user_id }}" data-url="{{ route('superadmin-user-post-assign-test') }}"><i class="far fa-save save-icon"></i>Assign Tests</button>

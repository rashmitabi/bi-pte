                ...
                <div class="test-series">
                    @if(count($tests) > 0)
                        ...
                        @foreach($tests as $test)
                            ...
                            @endphp
                            <div class="form-check  form-check-inline ">
                                <input type="checkbox" class="form-check-input multitest singletest{{ $temp }}" name="test[]" id="Check{{ $test->id }}" value="{{ $test->id }}">
                    ...
                    <div class="form-group row">
                        <div class="col-11 assign-btn">
                                <button type="button" class="btn btn-outline-primary store-multiple-assign-test" data-test-type="{{ $type }}" data-user-id="{{ $user_id }}" data-url="{{ route('superadmin-user-post-multiple-assign-test') }}"><i class="far fa-save save-icon"></i>Assign Tests</button>

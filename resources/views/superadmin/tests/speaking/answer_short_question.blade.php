                    ...
                    @for($i=0;$i<$count;$i++)
                      <div class=" col-12 mt-5 mb-1 ml-1 pr-3 white-bg common-col">
                        ...
                        <div class="form-group mb-2 row">
                           <label class="col-3 col-form-label">Question {{ $i+26 }}</label>
                           <div class="col-9 p-0">

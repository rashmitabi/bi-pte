...
class ListeningQuestionController extends Controller
{
    ...
    public function storeMultipleChoiceChooseSingle(Request $request)/*Store listening multiple choice choose single*/
    {
        ...
        if($questions->save())
        {
            ...
            return redirect()->route('branchadmin-tests.show',$test_id)->with('success','Questions added Successfully!');
        }
        else
        {
            return redirect()->route('branchadmin-tests.show',$test_id)->with('error','Sorry!Something wrong.Try Again.');
        }
    }
    public function updateMultipleChoiceChooseSingle(Request $request)/*Update listening multiple choice choose single*/
    {
        ...
        try{
            ...
            return redirect()->route('branchadmin-tests.show',$test_id)->with('success','Questions updated Successfully!');
        }catch(\Exception $e){
            return redirect()->route('branchadmin-tests.show',$test_id)->with('error','Sorry!Something wrong.Try Again.');
        }
    }
